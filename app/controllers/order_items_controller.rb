  ...
  def update
		respond_to do |format|
			...
			if params[:order_item][:quantity].to_i == 0
				@order_item.destroy
				format.html { redirect_to Order.find_by(id: @order_item.order_id), notice: 'Order item was successfully removed.' }
			
      elsif @order_item.update(order_item_params)
        format.html { redirect_to Order.find_by(id: @order_item.order_id), notice: 'Order item was successfully updated.' }
